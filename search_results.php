...
<?php
    ...
    // $raw_search_word = $_GET['search_word'];

    $filter_search_word = filter_var($_GET['search_word'],FILTER_SANITIZE_STRING);
    $search_word = mysqli_real_escape_string($conn, $filter_search_word);
    // echo $search_word;
